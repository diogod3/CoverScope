...
try {
    ...
    $requiredEntries = @(
        ...
        "tools/net10.0/any/wwwroot/review.css",
        "tools/net10.0/any/wwwroot/brand.css",
        "tools/net10.0/any/wwwroot/solution-browser.css",
        "tools/net10.0/any/wwwroot/review-progress.css",
        "tools/net10.0/any/Microsoft.CodeAnalysis.Workspaces.MSBuild.dll",
        "tools/net10.0/any/BuildHost-netcore/Microsoft.CodeAnalysis.Workspaces.MSBuild.BuildHost.dll",
        "tools/net10.0/any/BuildHost-netcore/Microsoft.CodeAnalysis.Workspaces.MSBuild.BuildHost.runtimeconfig.json",
        "tools/net10.0/any/BuildHost-netcore/Microsoft.CodeAnalysis.Workspaces.MSBuild.BuildHost.deps.json",
        "tools/net10.0/any/BuildHost-netcore/Microsoft.Build.Locator.dll",
